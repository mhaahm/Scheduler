import {Controller, Get, Query, Post, Body, Res, HttpStatus, Param,Delete} from '@nestjs/common';
...
export class CollectorController {
    ...
    create(@Body() createCollector: CreateCollectorDto,@Res() res: Response) {
            this.collectroService.saveUser(createCollector).then((resp)=>{
    ...
    {
        return this.collectroService.removeCollector(id).then(() => {
